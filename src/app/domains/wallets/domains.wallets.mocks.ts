...
export const WALLET_TRANSACTIONS_API_RESPONSE_2 = [
  { id: 4, creationDate: new Date(2018, 7, 12).toLocaleDateString(), description: 'description 4', amount: 320, type: WalletTransactionType.Incomes },
  { id: 5, creationDate: new Date(2018, 1, 5).toLocaleDateString(), description: 'description 5', amount: 150, type: WalletTransactionType.Expenses },
  { id: 6, creationDate: new Date(2018, 3, 1).toLocaleDateString(), description: 'description 6', amount: 510, type: WalletTransactionType.Incomes },
];

export function WALLET_TRANSACTIONS_API_RESPONSE_MOCK(id: number): IWalletTransactionApiResponse[] {
  if(id === 1) {
    return  WALLET_TRANSACTIONS_API_RESPONSE_1;
  }

  return WALLET_TRANSACTIONS_API_RESPONSE_2;
}
