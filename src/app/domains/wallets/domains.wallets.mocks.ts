...
import { IWalletApiResponse, IWalletTransactionApiResponse } from './domains.wallets.types';
...
export function WALLET_DETAILS_API_RESPONSE_MOCK(id: number): IWalletTransactionApiResponse[] {
  return  [
      ...
      { id: 2, creationDate: new Date(2020, 1, 5).toLocaleDateString(), description: 'description 2', amount: -50, type: WalletTransactionType.Expences },
